...
function App() {
    ...
    const tutorialSteps: string[] = [
        ...
        "See the nodes in the centre of the screen? Those are the base categories.",
        ...
        "Click on the 'ecosystems' node (under nature - biology - ecology) , and then the 'meteorology' node (under science) to bridge the gap.\nName the new connection 'influences' to represent the relationship. Also make it a double sided relationship to show that they both influence one another.",
        "Notice how you have changed the organisation of concepts on the graph",
        ...
        "Click on the connection between science and meteorology and downvote it using the arrow on the right to express that you want it to disappear in future, as you prefer your new path",
        ...
        "Select 'nature' for the root category",
        "Type 'associated with' in the first connection label, and leave the direction as neutral or undirected",
